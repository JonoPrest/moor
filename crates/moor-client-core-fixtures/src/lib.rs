//! Example values for every `moor-client-core` type that crosses the host ↔
...
//! `moor-protocol-fixtures`; protocol values inside view types come from
...
use moor_protocol::*;
use moor_protocol_fixtures::{Fixture, FixtureError, Fixtures as ProtoFixtures, Registered};
use serde::Serialize;
use serde::de::DeserializeOwned;
use serde_json::Value;
use strum::IntoEnumIterator;

/// Same contract as `moor_protocol_fixtures::Fixtures`, defined here so it
/// can be implemented for `moor-client-core` types (orphan rule).
...
/// `registry!(TypeA, ...)` builds `registry()`; see `moor-protocol-fixtures`.
...
// ---------------------------------------------------------------------------
// Example builders. Protocol values come from `moor-protocol-fixtures`.
// ---------------------------------------------------------------------------
